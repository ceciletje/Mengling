...
## 2. Reaction Times at Spillover Regions ##
### Spillover1 ###
...
summary(data.lmer3f)
#Linear mixed model fit by maximum likelihood  ['lmerMod']
#Formula: Spillover3.LogRT ~ (1 | Reading.baseline.LogRT) + (1 | CSTSwhole) + Group * Verb.Type
#Data: data

#AIC      BIC   logLik deviance df.resid 
#5029.5   5087.9  -2505.7   5011.5     4851 

#Scaled residuals: 
#  Min      1Q  Median      3Q     Max 
#-4.4716 -0.5860 -0.0937  0.4131  6.9487 

#Random effects:
#  Groups                 Name        Variance Std.Dev.
#CSTSwhole              (Intercept) 0.03272  0.1809  
#Reading.baseline.LogRT (Intercept) 0.04058  0.2015  
#Residual                           0.15120  0.3888  
#Number of obs: 4860, groups:  CSTSwhole, 90; Reading.baseline.LogRT, 54

#Fixed effects:
#                     Estimate  Std. Error t value
#(Intercept)          5.889195   0.053996  109.07
#GroupL2              0.385189   0.058295    6.61
#Verb.Typev1         -0.025790   0.050837   -0.51
#Verb.Typev2         -0.027300   0.050837   -0.54
#GroupL2:Verb.Typev1 -0.071184   0.027401   -2.60
#GroupL2:Verb.Typev2 -0.005513   0.027401   -0.20

#Correlation of Fixed Effects:
#  (Intr) GropL2 Vrb.T1 Vrb.T2 GL2:V.T1
#GroupL2     -0.580                              
#Verb.Typev1 -0.471  0.068                       
#Verb.Typev2 -0.471  0.068  0.500                
#GrpL2:Vr.T1  0.136 -0.235 -0.289 -0.145         
#GrpL2:Vr.T2  0.136 -0.235 -0.145 -0.289  0.500
...
## 3. Reaction Times after Spillover Regions ##
